...
function KarnaughMapDataCtrl(qmcRef) {
  ...
  this.setFuncData = function(fieldId, val) {
    ...
    if(!this.allowDontCare & val != 0 && val != 1) {
...
function KarnaughMap(parentDivId, parentIntermediateDivId, qmcRef, inputVarCount, kMapOutputName, kMapInputNames) {
  ...
  var intermediateDivId = parentIntermediateDivId;
  ...
  this.init = function () {
    ...
    //console.log("called init for div "+divId);
  ...
  function getMouse(e) {
    var elementTop = document.getElementById(divId);
    var elementMed = document.getElementById(parentDivId);
    var element = elementTop;
